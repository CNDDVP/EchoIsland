...
pub(crate) struct NativePanelRuntimeInputDescriptor {
    ...
    pub(crate) screen_physical_frame: Option<PanelRect>,
}
...
pub(crate) struct NativePanelHostWindowDescriptorPatch {
    ...
    pub(crate) screen_physical_frame: Option<Option<PanelRect>>,
...
impl NativePanelHostWindowDescriptor {
    ...
    pub(crate) fn window_state(self, frame: Option<PanelRect>) -> NativePanelHostWindowState {
        NativePanelHostWindowState {
            ...
            screen_physical_frame: self.screen_physical_frame,
...
pub(crate) fn sync_native_panel_host_window_screen_frame_and_scale(
    ...
    screen_physical_frame: Option<PanelRect>,
) {
    patch_native_panel_host_window_descriptor(
        descriptor,
        NativePanelHostWindowDescriptorPatch {
...
pub(crate) fn patch_native_panel_host_window_descriptor(
    ...
    if let Some(screen_physical_frame) = patch.screen_physical_frame {
        descriptor.screen_physical_frame = screen_physical_frame;
    }
