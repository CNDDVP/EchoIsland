# EchoIsland — CNDDVP Simplified Chinese Enhanced Edition

[简体中文](README.md) · [Technical upstream](https://github.com/FunplayAI/EchoIsland)

Community-maintained Windows-first fork under the MIT license. Current development version: 0.7.0 (CN tag convention: v0.7.0-cn), based on upstream a7ebfff. This version number does not mean a release has been published. Download only from [CNDDVP Releases](https://github.com/CNDDVP/EchoIsland/releases); unavailable update metadata falls back to manual updates. The upstream introduction below describes the shared technical foundation. Refer to the Chinese README and audit reports for current fork capabilities and verification limits.
...
- `EchoIsland_0.7.0_x64-setup.exe` (Simplified Chinese NSIS)
- `EchoIsland_0.7.0_x64_zh-CN.msi` (Simplified Chinese MSI)
